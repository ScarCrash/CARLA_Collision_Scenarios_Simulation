...
# 0.0 = vehicle's vertical center, 1.0 = roofline (flush with the roof, not
# above it -- CAMERA_CLEARANCE_MARGIN is only applied on the x/y axes).
LARGE_VEHICLE_CAMERA_HEIGHT_FRACTION = 1.0
